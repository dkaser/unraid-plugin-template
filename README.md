...
- **phpstan**: Checks your PHP code for potential bugs before you test it - catches issues that might not show up during testing
...
While we recommend keeping these tools enabled:
